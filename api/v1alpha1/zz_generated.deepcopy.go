...
func (in *PipelineRunStatus) DeepCopyInto(out *PipelineRunStatus) {
	*out = *in
	if in.TaskRuns != nil {
		...
		*out = make([]PipelineTaskRunStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PipelineTaskRunStatus) DeepCopyInto(out *PipelineTaskRunStatus) {
	*out = *in
	in.TaskRunStatus.DeepCopyInto(&out.TaskRunStatus)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PipelineTaskRunStatus.
func (in *PipelineTaskRunStatus) DeepCopy() *PipelineTaskRunStatus {
	if in == nil {
		return nil
	}
	out := new(PipelineTaskRunStatus)
	in.DeepCopyInto(out)
	return out
}
